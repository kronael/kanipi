...
| `paths.md`                 | shipped   | `ENOENT` unlink errors are handled, `HOST_DATA_DIR` export exists, and `hostPath()` has been eliminated in favor of explicit `HOST_GROUPS_DIR`, `HOST_DATA_DIR`, `HOST_APP_DIR` usage.                       |
