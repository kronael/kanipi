...
HTTP auth layer for the kanipi web UI. Local accounts (shipped)
and OAuth providers (not started).

Local: argon2id passwords, CLI user management, JWT + refresh.
OAuth: Telegram widget, Discord, GitHub, Google via arctic.
