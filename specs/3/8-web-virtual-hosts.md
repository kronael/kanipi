...
See `specs/2/5-permissions.md` for tier definitions.
...
- specs/2/5-permissions.md — tier model, mount enforcement
- specs/2/B-worlds-rooms.md — group hierarchy research
